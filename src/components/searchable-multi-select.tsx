...
export function SearchableMultiSelect({
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div
          className="absolute left-0 right-0 top-full z-20 mt-3 rounded-3xl border border-white/10 bg-[#0c0c0c] p-3 shadow-2xl shadow-black/50"
          role="dialog"
          aria-label={label}
        >
          ...
          <div className="mt-3 max-h-64 overflow-y-auto pr-1" role="listbox" id={listboxId} aria-label={label}>
