...
- 2026-06-30: onboarding now uses a sequential wizard on `/onboarding`; step 1 shows only languages, step 2 holds the milestone/confidence question, and step 3 keeps focus tags plus final submission in a separate card.
